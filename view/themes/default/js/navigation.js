...
WOA.navigation =
{
   model :
   {
      ...
      initAudioPlayer : function() {
         $.get('music/latest_mix', function(data) {
            ...
            AudioPlayer.setup("http://www.worldofanarchy.com/archives/playlist/js/audio-player/audio-player.swf", { width: 370, bg: 000000 });
            AudioPlayer.embed("latest-mix", {
                soundFile: data.url,
            ...
            $('#nav-music-player a.download').attr('href', data.url).attr('download', data.artist + ': ' + data.title + ' - WorldOfAnarchy.com.mp3');
         });
      }
   },
   view :
